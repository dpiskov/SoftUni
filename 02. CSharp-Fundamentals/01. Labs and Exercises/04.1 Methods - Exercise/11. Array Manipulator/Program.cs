...
while ((command = Console.ReadLine()) != "end")
{
    ...
    else if (cmdType == "first" || cmdType == "last")
    {
        ...
        if (cmdType == "first")
        {
            elements = FirstEvenOrOddCountElements(arr, count, evenOrOddArg);
        }
        else
        {
            elements = LastEvenOrOddCountElements(arr, count, evenOrOddArg); 
        }
        PrintArray(elements);
    }
}
...
static int[] FirstEvenOrOddCountElements(int[] arr, int count, string evenOrOddArg)
{
...
static int[] LastEvenOrOddCountElements(int[] arr, int count, string evenOrOddArg)
{
    int[] firstElArr = new int[count];
    int firstElArrIndex = 0;
